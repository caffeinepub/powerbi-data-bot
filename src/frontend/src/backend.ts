...
export class Backend implements backendInterface {
    ...
    async addDataSource(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDataSource(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBotConfig(arg0: string, arg1: Array<string>, arg2: Array<AIQuery>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBotConfig(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBotConfigs(): Promise<Array<BotConfig>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBotConfigs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllDataSources(): Promise<Array<DataSource>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDataSources();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBotConfig(arg0: string): Promise<BotConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.getBotConfig(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDataSource(arg0: string): Promise<DataSource> {
        if (this.processError) {
            try {
